...
public class IncomeAddTypeList extends AppCompatActivity {
    private RecyclerView intypeRecyclerView;
    private IncomeIntypeAdapter intypeAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.income_add_type);
        ...
        intypeAdapter = new IncomeIntypeAdapter(this);
        ...
        findViewById(R.id.income_add_newType).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String message_intype_add = "income";
