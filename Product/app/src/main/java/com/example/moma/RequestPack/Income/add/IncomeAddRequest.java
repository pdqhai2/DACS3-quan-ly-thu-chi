package com.example.moma.RequestPack.Income.add;

public class IncomeAddRequest {
    int user_id, intype_id, income_id, income_val, income_val_2 ;
    String income_name, income_valstring, income_day, income_month, income_year;
