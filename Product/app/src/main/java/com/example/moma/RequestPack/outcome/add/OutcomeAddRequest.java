package com.example.moma.RequestPack.outcome.add;

public class OutcomeAddRequest {
    int user_id, outtype_id, outcome_id, outcome_val, outcome_val_2 ;
    String outcome_name, outcome_valstring, outcome_day, outcome_month, outcome_year;
