...
public class IncomeListByIntypeAdapter extends RecyclerView.Adapter<IncomeListByIntypeAdapter.ViewHolder> {

    private Context context;
    private List<Income> incomeList;

    public IncomeListByIntypeAdapter(Context context) {
